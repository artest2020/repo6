...
import br.repo6.config.audit.AuditEventConverter;
import br.repo6.domain.PersistentAuditEvent;
...
import static br.repo6.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
